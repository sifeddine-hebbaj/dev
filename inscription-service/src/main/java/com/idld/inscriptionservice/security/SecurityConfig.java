...
import com.idld.inscriptionservice.filter.JwtTokenFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(ar->ar.requestMatchers("/auth/login/**", "/actuator/health", "/actuator/info").permitAll())
